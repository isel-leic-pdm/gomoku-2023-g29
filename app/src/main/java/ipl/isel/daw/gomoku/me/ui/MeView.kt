package ipl.isel.daw.gomoku.me.ui
...
fun ProfileView(player: PlayerInfo) {
    Card(
        ...
        Column(modifier = Modifier.padding(8.dp)) {
            ...
            Text(
                text = stringResource(id = R.string.me_gamesplayed)+ " ${player.njogos}",
                style = MaterialTheme.typography.subtitle1,
                textAlign = TextAlign.Center,
                maxLines = 1,
                modifier = Modifier
            ...
            Text(
                text = stringResource(id = R.string.me_totalpoints)+ "${player.wins}",
                style = MaterialTheme.typography.subtitle1,
                textAlign = TextAlign.Center,
                maxLines = 1,
                modifier = Modifier
...
fun GamesHistoryView(gameHistory: GameDTO) {
    Card(
        ...
        Row(
            ...
            Text(
                text = gameHistory.player1.toString(),
                style = MaterialTheme.typography.subtitle1,
                textAlign = TextAlign.Center,
                maxLines = 1,
                modifier = Modifier
            ...
            Text(
                text = gameHistory.player2.toString(),
                style = MaterialTheme.typography.subtitle1,
                textAlign = TextAlign.Center,
                maxLines = 1,
                modifier = Modifier
...
private val myGamesHistory = buildList {
    repeat(10) {
        add(GameDTO(UUID.randomUUID(), "ENDED", "test", UUID.randomUUID(), UUID.randomUUID(), "___", "___", "1", 1))
    }
}
